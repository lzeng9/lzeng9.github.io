...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "publications",
          description: "Publications are listed below in reverse chronological order.",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-decentralized-diffusion-decomposing-information-diffusion-in-federated-social-networks-is-now-available-in-the-icwsm-2026-proceedings",
          title: '📄 “Decentralized Diffusion: Decomposing Information Diffusion in Federated Social Networks” is now available...',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("/assets/pdf/zeng_CV.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%4C.%5A%65%6E%67@%74%69%6C%62%75%72%67%75%6E%69%76%65%72%73%69%74%79.%65%64%75", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=ztoH39AAAAAJ", "_blank");
        },
      },{
      id: 'light-theme',
